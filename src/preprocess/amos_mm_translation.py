...
findings_file_path = "datasets/Fused_Dataset/train/amos_mm_findings_translation.jsonl"
vqa_file_path = "datasets/Fused_Dataset/train/amos_mm_vqa_translation.jsonl"
