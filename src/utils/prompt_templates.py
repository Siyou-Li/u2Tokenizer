...
general_questions = [
        "Could you create a detailed report from the findings in this CT scan?",
        "Could you produce a full medical report interpreting this CT scan?",
        "Can you create a diagnostic narrative based on the information from this CT image?",
        "Can you generate a full clinical analysis from this CT scan?",
        "Can you interpret this CT scan and provide a detailed medical report?",
        "Can you produce a detailed patient analysis using this CT scan?",
        "Can you draft a comprehensive report with the data from this CT image?",
        "Could you provide a detailed radiology report based on this CT image?",
        "Could you provide a thorough report based on the CT scan data?",
        "Can you draft a medical report using the results from this CT scan?",
        "Could you create a complete diagnostic report with this CT image?",
        "Based on this CT scan, can you create a detailed medical report?",
        "Can you generate a complete analysis report from this CT scan?",
        "Can you generate a report discussing the findings of this CT image?",
        "Can you compile a thorough medical report from this CT scan data?",
        "Can you provide a comprehensive medical report based on this CT scan?",
        "Could you write a complete patient status report using this CT scan?",
        "Could you write a thorough report based on the results of this CT scan?",
        "Can you compile a complete clinical report using this CT image as a reference?",
        "Can you construct a detailed medical report interpreting this CT image?",
        "Can you generate a medical report from this CT image?",
        "Could you provide a report based on the findings in this CT scan?",
        "Can you create a clinical write-up using this CT image data?",
        "Could you make a medical report interpreting this CT image?",
        "Can you compile a patient report from this CT scan?",
        "Could you craft a diagnostic report using this CT image?",
        "Can you interpret this CT scan into a medical report?",
        "Can you provide a patient report using this CT scan?",
        "Could you make a health report from this CT image?",
        "Can you draft a report based on the results of this CT scan?",
        "Could you write a health report using this CT image?",
        "Can you provide an analysis report from this CT scan?",
        "Could you write a patient report based on this CT image?",
        "Can you provide a report using the findings from this CT scan?",
        "Could you produce a diagnostic summary from this CT image?",
        "Can you generate a health report from this CT scan?",
        "Could you make a medical report from this CT image?",
        "Can you put together a diagnostic report based on this CT scan?",
        "Could you create a health summary from this CT image?",
        "Can you provide a clinical report based on this CT scan?",
]

general_questions_chinese = [
        "你能从这个CT图像创建一份健康摘要吗？",
        "你能从这个CT图像制作一份医疗报告吗？",
        "你能从这个CT图像提供一份诊断概要吗？",
        "你能从这个CT图像生成一份医疗报告吗？",
        "你能从这个CT扫描提供一份分析报告吗？",
        "你能从这个CT扫描数据编写一份详尽的医疗报告吗？",
        "你能从这个CT扫描生成一份健康报告吗？",
        "你能从这个CT扫描生成一份完整的分析报告吗？",
        "你能从这个CT扫描编写一份患者报告吗？",
        "你能使用这个CT图像写一份健康报告吗？",
        "你能使用这个CT图像数据创建一份临床报告吗？",
        "你能使用这个CT扫描提供一份患者报告吗？",
        "你能使用这个CT扫描的发现提供一份报告吗？",
        "你能使用这个CT扫描进行详细的患者分析吗？",
        "你能制作一个完整的医疗报告来解读这个CT扫描吗？",
        "你能将这个CT扫描解读为一份医疗报告吗？",
        "你能提供一份基于这个CT扫描发现的报告吗？",
        "你能根据这个CT图像写一份患者报告吗？",
        "你能根据这个CT图像制作出一份健康报告吗？",
        "你能根据这个CT图像的信息，创建一个诊断叙述吗？",
        "你能根据这个CT图像，提供一份详细的放射科报告吗？",
        "你能根据这个CT扫描提供一份临床报告吗？",
        "你能根据这个CT扫描提供一份全面的医疗报告吗？",
        "你能根据这个CT扫描数据，提供一份详尽的报告吗？",
        "你能根据这个CT扫描的发现，生成一个详细的报告吗？",
        "你能根据这个CT扫描的结果写一份详尽的报告吗？",
        "你能根据这个CT扫描的结果起草一份报告吗？",
        "你能根据这个CT扫描组合出一份诊断报告吗？",
        "你能根据这个CT扫描，生成一份完整的临床分析吗？",
        "你能生成一份讨论这个CT图像发现的报告吗？",
        "你能用这个CT图像为参考，编写一份完整的临床报告吗？",
        "你能用这个CT图像创建一个完整的诊断报告吗？",
        "你能用这个CT图像制作一份诊断报告吗？",
        "你能用这个CT图像的数据，起草一份全面的报告吗？",
        "你能用这个CT扫描写一份完整的患者状态报告吗？",
        "你能用这个CT扫描的结果起草一份医疗报告吗？",
        "你能解读这个CT图像并制作一份医疗报告吗？",
        "你能解读这个CT图像并造出一份详细的医疗报告吗？",
        "你能解读这个CT扫描并提供一个详细的医疗报告吗？",
        "基于这个CT扫描，你能创建一份详细的医疗报告吗？",
]
