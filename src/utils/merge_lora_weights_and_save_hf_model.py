...
class ModelArguments:
    ...
    pretrain_vision_model: str = field(default="/pfs/mt-1oY5F7/luoyihao/project/multimodal/AMOS-MM/M3D/pretrained_model/M3D-CLIP/pretrained_ViT.bin", metadata={"help": "Path to pretrained model for ViT."})
