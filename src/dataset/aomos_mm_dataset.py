...
if __name__ == '__main__':
    ...
    json_path = '/pfs/mt-1oY5F7/luoyihao/project/multimodal/AMOS-MM/M3D/datasets/AMOS-MM/dataset.json'
    ...
    dataset = MRGMIXDatasets(image_dir, json_path, output_size, patch_size, mode, tokenizer, 2048, data_type="training")
